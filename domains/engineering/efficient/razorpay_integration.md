...
1. Generate a **WebhookEvent** model with the following table columns **source:integer**, **payload:json**, **event\_type:string**, **status:integer**, **webhook\_event\_id:string**.
